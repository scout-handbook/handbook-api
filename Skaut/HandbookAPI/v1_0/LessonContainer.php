...
class LessonContainer implements \JsonSerializable
{
    ...
    {
        usort($this->lessons, 'Skaut\HandbookAPI\v1_0\Lesson::compare');
    }
    ...
    {
        if (get_class($first) === 'Skaut\HandbookAPI\v1_0\LessonContainer') {
            if (get_class($second) === 'Skaut\HandbookAPI\v1_0\LessonContainer') {
                return 0;
            }
            return -1;
        }
