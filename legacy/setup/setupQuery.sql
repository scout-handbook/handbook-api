...
CREATE TABLE IF NOT EXISTS `competences` (
  ...
  `number` varchar(15) COLLATE utf8mb4_czech_ci NOT NULL,
...
INSERT INTO `fields` (`id`, `name`, `description`, `image`, `icon`) VALUES
(0x834e889c03664959a6f674707a33c1ce, 'Skauting', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0x1db1540ff8294b449c013cb9ecd56fa1, 'Prevence a krize', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0x26399db899e84e909309ccd2937d3544, 'Práce v týmu a vedení', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0x29d7c37f9d674e2086d74ae8846fb931, 'Plánování a organizování', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0x2e5bf7bba48f497f881c230ccb7fce56, 'Sebereflexe a seberozvoj', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0x4919e4b8da7140da9d0f2e96261a0e42, 'Rozvoj dětí a dospělých', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000),
(0xdd8ac1b9b22241788715e826167cdfce, 'Komunikace', '', 0x00000000000000000000000000000000, 0x00000000000000000000000000000000);
